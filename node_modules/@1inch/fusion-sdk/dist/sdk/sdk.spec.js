...
describe(__filename, () => {
    ...
    it('throws an exception if order is not get from api', async () => {
        ...
        await expect(promise).rejects.toThrow('Can not get order with the specified orderHash 0x1beee023ab933cf5446c298eadadb61c05705f2156ef5b2db36c160b36f31ce4');
    });
});
