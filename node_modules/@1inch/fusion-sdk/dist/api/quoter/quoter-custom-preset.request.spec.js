...
describe(__filename, () => {
    ...
    it('points should be in range', () => {
        const body1 = quoter_custom_preset_request_1.QuoterCustomPresetRequest.new({
            customPreset: {
                auctionDuration: 180,
                auctionStartAmount: '100000',
                auctionEndAmount: '50000',
        ...
        const body2 = quoter_custom_preset_request_1.QuoterCustomPresetRequest.new({
            customPreset: {
                auctionDuration: 180,
                auctionStartAmount: '100000',
                auctionEndAmount: '50000',
...
//# sourceMappingURL=quoter-custom-preset.request.spec.js.map