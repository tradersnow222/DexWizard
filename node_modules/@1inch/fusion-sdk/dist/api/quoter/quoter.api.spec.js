...
const quoter_custom_preset_request_1 = require("./quoter-custom-preset.request");
describe('Quoter API', () => {
    let httpProvider;
    beforeEach(() => {
        httpProvider = {
    ...
    const QuoterResponseMock = new quote_1.Quote(params, ResponseMock);
    it('should get quote with disabled estimate', async () => {
        ...
        expect(httpProvider.get).toHaveBeenCalledWith('https://test.com/quoter/v1.0/1/quote/receive/?fromTokenAddress=0x6b175474e89094c44da98b954eedeac495271d0f&toTokenAddress=0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2&amount=1000000000000000000000&walletAddress=0x00000000219ab540356cbb839cbe05303d7705fa&source=sdk');
    });
    ...
    it('getQuoteWithCustomPreset', async () => {
        ...
        const body = quoter_custom_preset_request_1.QuoterCustomPresetRequest.new({
            customPreset: {
                auctionDuration: 180,
        ...
        expect(res).toStrictEqual(QuoterResponseMock);
        expect(httpProvider.post).toHaveBeenCalledWith('https://test.com/quoter/v1.0/1/quote/receive/?fromTokenAddress=0x6b175474e89094c44da98b954eedeac495271d0f&toTokenAddress=0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2&amount=1000000000000000000000&walletAddress=0x00000000219ab540356cbb839cbe05303d7705fa&fee=1&source=0x6b175474e89094c44da98b954eedeac495271d0f', body.build());
    });
});
