...
describe(__filename, () => {
    it('should return error if native currency', () => {
        expect(() => quoter_request_1.QuoterRequest.new({
            fromTokenAddress: limit_order_sdk_1.Address.NATIVE_CURRENCY.toString(),
    ...
    it('returns error fromTokenAddress or toTokenAddress equals ZERO_ADDRESS', () => {
        expect(() => quoter_request_1.QuoterRequest.new({
            fromTokenAddress: limit_order_sdk_1.Address.ZERO_ADDRESS.toString(),
            toTokenAddress: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
            amount: '1000000000000000000000',
            walletAddress: '0x00000000219ab540356cbb839cbe05303d7705fa',
            fee: 1
        ...
        expect(() => quoter_request_1.QuoterRequest.new({
            ...
            toTokenAddress: limit_order_sdk_1.Address.ZERO_ADDRESS.toString(),
            amount: '1000000000000000000000',
            walletAddress: '0x00000000219ab540356cbb839cbe05303d7705fa',
            fee: 1
        })).toThrow(/replace/);
...
//# sourceMappingURL=quoter.request.spec.js.map