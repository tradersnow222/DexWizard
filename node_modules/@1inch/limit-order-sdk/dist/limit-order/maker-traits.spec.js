...
describe('MakerTraits', () => {
    test('allowed sender', () => {
        const traits = maker_traits_1.MakerTraits.default();
        const sender = address_1.Address.fromBigInt(1337n);
    ...
    test('all', () => {
        const traits = maker_traits_1.MakerTraits.default()
            .withAllowedSender(address_1.Address.fromBigInt(byte_utils_1.UINT_160_MAX))
            .allowPartialFills()
            .allowMultipleFills()
            .withEpoch(byte_utils_1.UINT_40_MAX, byte_utils_1.UINT_40_MAX)
            .withExpiration(byte_utils_1.UINT_40_MAX)
            .withExtension()
            .enablePermit2()
            .enableNativeUnwrap()
...
//# sourceMappingURL=maker-traits.spec.js.map